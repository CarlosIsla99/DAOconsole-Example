...
public class DaoEmpleadoMemoria implements DaoEmpleado{
	...
	static {
		...
		empleados.put(2L, new Empleado(2L, "87654321X", "Rafa", LocalDate.of(1999, 2, 1), new BigDecimal("12543")));
		empleados.put(3L, new Empleado(3L, "18273645F", "Laura", LocalDate.of(1998, 4, 5), new BigDecimal("21543")));
	}
